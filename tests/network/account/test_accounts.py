...
def test_sign_message(accounts):
    ...
    assert message_hash == "0x131c497d4b815213752a2a00564dcf667c3bf3f85a410ef8cb50050b51959c26"
...
def test_sign_defunct_message(accounts):
    ...
    if ETH_ACCOUNT_LT_0_13_0:
        ...
        message_hash = signed.message_hash.hex()
    assert message_hash == "0xb9bb14ce5c17b2b7217cfa638031a542b95fc25b18d42a61409066001d01351d"
