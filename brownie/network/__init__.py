...
class Network:
    ...
    def connect(self, network=None, launch_rpc=False):
        if network is None:
    ...
    def disconnect(self, kill_rpc=False):
    ...
    def reset(self, network=None, launch_rpc=False):
        ...
        self.disconnect(launch_rpc)
        self.connect(network, launch_rpc)
