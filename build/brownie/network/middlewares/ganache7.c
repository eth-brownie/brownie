...
PyInit_ganache7(void)
{
    ...
    void *init_func = PyCapsule_GetPointer(capsule, "7e697ddbf4970f222ce8__mypyc.init_brownie___network___middlewares___ganache7");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit_ganache7(); }
