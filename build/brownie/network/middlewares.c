...
PyInit_middlewares(void)
{
    ...
    void *init_func = PyCapsule_GetPointer(capsule, "922a8319db12147c4c0e__mypyc.init_brownie___network___middlewares");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit_middlewares(); }
