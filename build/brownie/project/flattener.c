...
PyInit_flattener(void)
{
    ...
    void *init_func = PyCapsule_GetPointer(capsule, "b231d8a45f8022bf8159__mypyc.init_brownie___project___flattener");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit_flattener(); }
