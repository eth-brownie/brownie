...
PyInit_coverage(void)
{
    ...
    void *init_func = PyCapsule_GetPointer(capsule, "ccd0f1491df18aed4089__mypyc.init_brownie___test___coverage");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit_coverage(); }
